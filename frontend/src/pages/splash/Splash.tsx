            ...
            <div className="Splash-maincontent">
                ...
                <div className="Splash-regrettablesummary">
                    <h2 className="Splash-obnoxiousintroduction">
                        ...
                        If it's more on the introvert, or maybe on the extrovert, side of things? Have you ever had 
                        a sudden desire to let a completely random test on the internet tell you just that?
                    </h2>
                    <h2 className="Splash-insecurechallenge">
                        Then go ahead and complete this tried-and-true,
                        100%-trustworthy-and-scientific, totally-not-made-up personality test, and find out 
                        what stuff you're made of! Ehrm...personality-wise, I mean.
                    </h2>
                </div>
                <div className="Splash-nameinputmaincontainer">
                    <span className="Splash-namerequest">
                        To start, please tell me your name (believe me, this is absolutely relevant) and 
                        press the button below:
                    </span>
                    <div className="Splash-nameinputsubcontainer">
                        <input className="Splash-nameinput"

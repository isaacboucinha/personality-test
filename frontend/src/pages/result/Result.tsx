            ...
            <div className="Result-maincontent">
                ...
                <div className="Result-regrettablesummary">
                    <h2 className="Result-obnoxiousintroduction">
                        According to our super-duper metrics and analisys, your personality type is:
                    </h2>
                    <h2 className="Result-personalitytype">
                        100% Introvert
                    </h2>
                    <h2 className="Result-confusingexplanation">
                        You're the kind of person that might just get a heart attack from interacting with other people.
                        Social avoidance and peaceful contemplative moments are your bread and butter, and you rarely leave
                        those confort zones of yours. However, that often allows you to focus more on your personal goals and hobbies, and 
                        your journey of interior self-discovery holds many rewards, as long as you're not afraid to pursue it. You go!
                    </h2>
                </div>
